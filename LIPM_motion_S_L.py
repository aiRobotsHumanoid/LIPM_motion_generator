...
write_data = True
motion_file = "./source/motordata/Shift_L_data.csv"    # LIPM給模擬環境的動作檔 
w_file = "./Motion_cmd/Motion_Shift_L.csv" # motor的刻度檔案
...
class LIPM_motion:
    def __init__(self):
        ...
        self.h2 = 0.7   # 左腳hip (+)抬右腳更低, 重心偏左 (-)抬右腳更高   0.9
        ...
        # 腳底板傾斜角度, (+)腳尖往上 (-)腳尖往下
        self.CR1 = 0 # (+)腳尖往上 (-)腳尖往下
        self.CR2 = 0 
        self.CL1 = 0  # (+)腳尖往下 (-)腳尖往上
        self.CL2 = 0
        ...
        self.Rup = False                 # Rup: 是否先抬右腳(False會導致H1:左腳 H2:右腳 跨步距離也會相反 Code 256行)
        self.Forward = False
        self.Shift = True
        self.NoPeriod_acc = 0
        self.NoPeriod_dec = 0
