...
#         """ LIPM參數設定, 1右 2左 """
#         # 大腿擺幅, |0.05| < B < |0.1|
#         self.B1 = -99* 0.001  # (+)往內畫 (-)往外畫 -0.04 
#         self.B2 = 108 * 0.001  # (+)往外畫 (-)往內畫

#         # Hip側開
#         self.h1 = 0.54    # 右腳hip (+)抬左腳更低, 重心偏右 (-)抬左腳更高  -0.8
#         self.h2 = 0.71   # 左腳hip (+)抬右腳更低, 重心偏左 (-)抬右腳更高   0.9
...
#                             #    1      2       3       4       5                   
#         self.A_Lean_angle_R = [[ -5,   -8,    -8,    -8,     -9], \
#                                [ -7,      -5,    -3,   -3,     -5 ] ]
#         self.A_Lean_angle_L = [[ -0.4,     -0.7,   -0.7,   -0.7,     -0.8], \
#                                [-0.3,    -1,    -2,    -1.5,      -1.2]]
...
#         # 調整Hip yaw角度, (+)往左 (-)往右
#         self.Turn = False
#         self.A_DesiredTheta_R = [[  0,   0,   0,   -1,   -2.5],\
#                                  [  -2.5,   -1.5,   -0.5,   0,   0]]
...
class LIPM_motion:
    def __init__(self):
        ...
        # Lean angle sequence [[step1], [step2]]
                            #    1      2       3       4       5                   
        self.A_Lean_angle_R = [[ -5,   -8,    -8,    -8,     -10], \
                               [ -8,      -5,    -2,   -2,     -3] ]
        self.A_Lean_angle_L = [[ -0.5,     -2,   -0.8,   -0.1,     0.2], \
                               [0.3,    0.2,    -0.5,    -0.3,      -0.5]]
        ...
        self.A_DesiredTheta_R = [[  0,   0,   0,   -1,   -2.5],\
                                 [  -2.5,   -1.5,   -0.5,   0,   0]]
        self.A_DesiredTheta_L = [[  0,   0,   0,   0.5,   1],\
                                 [  1,   0.5,   0,   0,   0]]
