...
class LIPM_motion:
    def __init__(self):
        """ LIPM參數設定, 1右 2左 """
        # 大腿擺幅, |0.05| < B < |0.1|
        self.B1 = -102* 0.001  # (+)往內畫 (-)往外畫 -0.04 
        self.B2 = 100 * 0.001  # (+)往外畫 (-)往內畫

        # Hip側開
        self.h1 = 0.350    # 右腳hip (+)抬左腳更低, 重心偏右 (-)抬左腳更高  -0.8
        ...
        #                        [ -10,      -6,    -3,   -3,     -2 ] ]           
        self.A_Lean_angle_R = [[ 1,   0,    -5,    -9,     -5], \
                                [ -2.5,      -2.,   -1.,   0,     1]]  # [ -1,      -0,   0.5,   1,     1.2][ -5,      -4,   -1.5,   0,     1] [ -4,      -3,   -2,   0,     1]
        self.A_Lean_angle_L = [[ -1,     -2.5,   -1.5,   -0.5,     -1], \
                               [-1,    -1,    0,    0.3,      0.5]]
        ...
        """ 機器人基礎姿態設定 """
        # Set Initial Pose
        self.initR = [0,  -0.01,   -0.37, -0.77,  0.41,  0] 
        self.initL = [0,  -0.03,    0.48,  0.78,  0.33,  -0.03]
