...
class LIPM_motion:
    def __init__(self):
        ...
        self.B2 = 75 * 0.001  # (+)往外畫 (-)往內畫

        # Hip側開
        self.h1 = 0.29    # 右腳hip (+)抬左腳更低, 重心偏右 (-)抬左腳更高  -0.8
        self.h2 = 0.29   # 左腳hip (+)抬右腳更低, 重心偏左 (-)抬右腳更高   0.9
        ...
        # Lean angle sequence [[step1], [step2]]
                            #    1      2       3       4       5                   
        self.A_Lean_angle_R = [[ -5,   -8,    -9,    -9,     -9], \
                               [ -10,      -9,    -7,   -5,     -5 ] ]
        self.A_Lean_angle_L = [[ -1.6,     -1.8,   -1.8,   -1.3,     -0.9], \
                               [-0.3,    -1,    -1.3,    -1.5,      -1.6]]
        ...
        """ 機器人基礎姿態設定 """
        # Set Initial Pose
        self.initR = [0,  -0.01,   0.39, -0.75,  0.39,  0.0] 
        self.initL = [0,  -0.03,   0.50, -0.75,  0.31,  -0.03]
