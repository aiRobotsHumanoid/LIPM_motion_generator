...
class LIPM_motion:
    def __init__(self):
        """ LIPM參數設定, 1右 2左 """
        # 大腿擺幅, |0.05| < B < |0.1|
        self.B1 = -98* 0.001  # (+)往內畫 (-)往外畫 -0.04 
        self.B2 = 92 * 0.001  # (+)往外畫 (-)往內畫

        # Hip側開
        self.h1 = 0.28    # 右腳hip (+)抬左腳更低, 重心偏右 (-)抬左腳更高  -0.8
        self.h2 = 0.50   # 左腳hip (+)抬右腳更低, 重心偏左 (-)抬右腳更高   0.9
        ...
        self.A_Lean_angle_R = [[ 1,   0,    -8,    -10,     -8], \
                                [ -8,      -2.,   0.,   1,     1]]  # [ -1,      -0,   0.5,   1,     1.2][ -5,      -4,   -1.5,   0,     1] [ -4,      -3,   -2,   0,     1]
        self.A_Lean_angle_L = [[ -1,     -3.5,   -2.5,   0,     0.5], \
                               [-1,    -1,    -1,    -1.2,      -1]]
